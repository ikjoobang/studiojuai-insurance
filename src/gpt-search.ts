...
│ 동양생명 │ 질병수술비  │ ?종수술  │ 기본 ?만원                     │ 급여기준    │
│ 신한라이프│ 질병수술비 │ ?종수술  │ ?만원~?만원                    │ 급여기준    │
│ 교보생명 │ 질병수술비  │ ?종수술  │ 최대 ?만원                     │ 급여기준    │
│ 삼성생명 │ 질병수술비  │ ?종수술  │ ?만원~?만원 (선택형)           │ 급여기준    │
└────────────────────────────────────────────────────────────────────────────────┘
...
│ 동양생명 │ 질병수술비  │ -                │ 포함     │ ?종수술비    │ 기본 ?만원        │
│ 신한라이프│ 질병수술비 │ -                │ 포함     │ ?종수술비    │ ?만원~?만원       │
│ 교보생명 │ 질병수술비  │ -                │ 포함     │ ?종수술비    │ 최대 ?만원        │
│ 삼성생명 │ 질병수술비  │ -                │ 포함     │ ?종수술비    │ ?만원 (선택형)    │
└─────────────────────────────────────────────────────────────────────────────────────┘
* 웹 검색으로 찾은 실제 약관상 한도 금액을 반드시 기입할 것!
...
- 최저 보장: [보험사명 - 실제 금액] (예: 교보생명 - 기본 30만원)
- 1-5종 특약: [각 보험사별 몇 종 분류 + 실제 한도]
- N대 특약: [각 보험사별 실제 한도 금액 비교]

### 중요 유의사항
- 위 금액은 웹 검색 기준 (2026년 현재)
